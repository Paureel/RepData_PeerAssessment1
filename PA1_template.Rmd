...
```
The 5 minute interval which contains the maximum is: `r maxrow`
...
```
The number of *NA* values: `r navalues`  
...
```
The **median** is `r numberofsteps.new.median` and the **mean** is `r numberofsteps.new.mean`.   
